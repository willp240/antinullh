...
all: bin/prune_trees bin/make_reactor_json bin/make_osc_grids bin/compare_osc_grids bin/fixedosc_llhscan bin/fixedosc_fit bin/makeFixedOscTree #bin/auto_corrs bin/make_plots bin/llh_scan bin/mcmc
