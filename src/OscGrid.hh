...
namespace antinufit
{
  ...
  {
  public:
    OscGrid(const std::string &filename_, const double &distance_, const double &mine_, const double &maxe_, const double &numvasse_,
        ...
        : fFilename(filename_), fDistance(distance_), fMinE(mine_), fMaxE(maxe_), fNumValsE(numvasse_),
